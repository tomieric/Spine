/**/{
  ...
  let $loading = load([load('//github.elemecdn.com/uglifyjs!YanagiEiichi/jinkela/1.2.14/jinkela.js').then(() => load('//github.elemecdn.com/uglifyjs!YanagiEiichi/jinkela/1.2.14/plugins/nesting.js')), '//github.elemecdn.com/chjj/marked/v0.3.6/marked.min.js', '//github.elemecdn.com/uglifyjs!isagalaev/highlight.js/9.6.0/src/highlight.js', '//github.elemecdn.com/cferdinandi/smooth-scroll/v10.0.1/dist/js/smooth-scroll.min.js', '//github.elemecdn.com/isagalaev/highlight.js/9.6.0/src/styles/default.css']);
